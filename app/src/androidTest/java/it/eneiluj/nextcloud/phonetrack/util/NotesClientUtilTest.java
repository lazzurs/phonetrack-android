...
public class NotesClientUtilTest extends TestCase {
    public void testFormatURL() {
        ...
        assertEquals("https://example.com/", NotesClientUtil.formatURL("example.com/index.php/apps/phonetrack"));
        assertEquals("https://example.com/", NotesClientUtil.formatURL("example.com/index.php/apps/phonetrack/api"));
        assertEquals("https://example.com/", NotesClientUtil.formatURL("example.com/index.php/apps/phonetrack/api/v0.2"));
        assertEquals("https://example.com/", NotesClientUtil.formatURL("example.com/index.php/apps/phonetrack/api/v0.2/phonetrack"));
        assertEquals("https://example.com/nextcloud/", NotesClientUtil.formatURL("example.com/nextcloud"));
        assertEquals("http://example.com:443/nextcloud/", NotesClientUtil.formatURL("http://example.com:443/nextcloud/index.php/apps/phonetrack/api/v0.2/phonetrack"));
    }
    ...
    public void testIsValidURLTest() {
        assertTrue(NotesClientUtil.isValidURL(null, "https://demo.nextcloud.org/"));
