...
import net.eneiluj.nextcloud.phonetrack.android.fragment.EditMapsLogjobFragment;
import net.eneiluj.nextcloud.phonetrack.model.DBLogjob;

public class EditMapsLogjobActivity extends EditLogjobActivity {
    ...
    protected void launchExistingLogjob(long logjobId) {
        ...
        fragment = EditMapsLogjobFragment.newInstance(logjobId);
        if (savedState != null) {
    ...
    protected void launchNewLogjob() {
        ...
        fragment = EditMapsLogjobFragment.newInstanceWithNewLogjob(newLogjob);
        getSupportFragmentManager().beginTransaction().replace(android.R.id.content, fragment).commit();
    }
}