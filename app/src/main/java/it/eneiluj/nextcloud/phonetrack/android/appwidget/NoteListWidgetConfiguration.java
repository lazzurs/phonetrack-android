...
import it.eneiluj.nextcloud.phonetrack.android.activity.NotesListViewActivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapterCategories = new NavigationAdapter(new NavigationAdapter.ClickListener() {
            ...
            public void onItemClick(NavigationAdapter.NavigationItem item) {
                ...
                sp.putBoolean(NoteListWidget.DARK_THEME_KEY + appWidgetId, PhoneTrack.getAppTheme(getApplicationContext()));
                sp.apply();
